...
# <div class="fancybox-inner" style="overflow: visible; width: 640px; height: 350px;"><img class="fancybox-image" src="image/featured/mars2.jpg" alt=""></div>
...
print(results[0].find('h3'))
print(results[1].find('h3'))
print(results[2].find('h3'))
print(results[3].find('h3'))
